...
const EnhancedTestimonials: React.FC = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text: 'Очень понравилось, как детально всё расписано. Особенно впечатлил бот по SEO статьям 🤣 Это офигенно, что он может прямо за нас писать эти статьи, причем и темы он выбрал прикольные\nПолезно было в целом про функционал, про то, как чат думает. Про генерацию картинок тоже круто — я это команде еще расскажу'
    }
  ];
