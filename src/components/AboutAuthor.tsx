        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-12 shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-[#E76832] to-[#FFC24B] rounded-2xl p-[3px] transform group-hover:scale-[1.02] transition-all duration-300">
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {benefits.map((benefit, index) => (
                <div 
                  key={index}
                  className="flex items-start gap-4 p-4 sm:p-5 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl hover:from-orange-100 hover:to-amber-100 transition-all duration-300 border border-[#E76832]/10"
                >
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute inset-0 bg-gradient-to-r from-[#E76832] to-[#FFC24B] rounded-2xl p-[2px] opacity-70">
              <div className="h-full w-full bg-white rounded-2xl"></div>
            </div>
