...
const FAQ: React.FC = () => {
  ...
  },
  {
    ...
    answer: "Да! Пока гайд в продаже, я регулярно обновляю его под новые функции. Только за три недели написания мне пришлось переписать 3 главы из-за новых возможностей ChatGPT. Покупая сейчас, ты получаешь все будущие обновления бесплатно."
  },
  {
  ...
  },
  {
    ...
    answer: "Для оплаты есть удобные сервисы-посредники, а настройка VPN занимает буквально 5 минут. Если возникнут сложности, пиши мне в Телеграм @Ilya_Plv — помогу решить."
  },
  {
    question: "Есть ли в гайде готовые сценарии для конкретных профессий?",
    answer: "В гайде я фокусируюсь на универсальных принципах, которые работают в любой сфере. Но в разделе с 50+ промптами ты найдёшь готовые шаблоны для маркетологов, копирайтеров, дизайнеров, разработчиков, менеджеров и других профессий. Плюс ты научишься адаптировать любой шаблон под свои задачи."
  },
  {
    question: "А вдруг гайд окажется бесполезным?",
    answer: "На создание гайда я потратил более 60 часов — это примерно 8-9 часов на главу. Уверен, что на русском рынке ты не найдёшь более подробного и структурированного материала по ChatGPT. Если найдешь, то буду рад ознакомиться"
  },
];
