...
const FAQ: React.FC = () => {
  ...
  },
  {
    ...
    answer: "Для оплаты есть удобные сервисы-посредники, а настройка VPN занимает буквально 5 минут. Если возникнут сложности, пишите мне в Телеграм @Ilya_Plv — помогу решить."
  },
  {
  ...
  },
  {
    ...
    answer: "На создание гайда я потратил более 60 часов — это примерно 8-9 часов на главу. Уверен, что на русском рынке вы не найдёте более подробного и структурированного материала по ChatGPT. Если найдете, то буду рад ознакомиться"
  },
];
