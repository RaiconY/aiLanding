...
const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    {
      text: "\nКрутой авторский контент и откликается многое. Я когда начинаю думать о том, какие возможности открываются с развитием ИИ, мне в прямом смысле слова на месте не сидится\n",
      author: ""
    }
  ];
