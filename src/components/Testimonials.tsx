...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      text: "\nВо-первых, это отдельное эстетическое удовольствие, которое я получаю от всего, к чему ты прикасаешься. Потому что то, что ты делаешь — это правда очень красиво и очень структурно\n\nВторое, что мне очень понравилось — ты пишешь с примерами. Очень классно, что они есть 😋\n",
      author: "Александра"
    },
    {
      text: "Первые три дня использования ChatGPT после изучения материалов — это просто кайф полнейший! Я теперь решаю любые вопросы мгновенно: от планирования покупок в магазине до сложных рабочих задач. Всё стало настолько легко, быстро и информативно, что не представляю, как раньше обходился без этого",
      author: ""
    },
    {
