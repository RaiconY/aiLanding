...
const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    {
      text: "Первые три дня использования ChatGPT после изучения материалов — это просто кайф полнейший! Я теперь решаю любые вопросы мгновенно: от планирования покупок в магазине до сложных рабочих задач. \n\nВсё стало настолько легко, быстро и информативно, что не представляю, как раньше обходился без этого\n",
      author: ""
    },
    {
