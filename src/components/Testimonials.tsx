...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      text: "Во-первых, это отдельное эстетическое удовольствие. Которое я получаю от всего, к чему ты прикасаешься. Потому что это правда очень красиво и очень структурно — то, что ты делаешь.\n\nВторое, что мне очень понравилось — ты пишешь с примерами. Очень классно, что они есть 😋",
      author: ""
    },
    {
