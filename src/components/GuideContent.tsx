...
const GuideContent: React.FC = () => {
  const chapters = [
    {
      number: '01',
      title: 'Правильно настрой ChatGPT',
      topics: [
    ...
    {
      number: '11',
      title: 'Learn & Study Mode: ChatGPT как учитель',
      topics: [
        'Поймешь, чем режим "Учёба и обучение" отличается от обычного ChatGPT',
        'Освоишь, в каких случаях лучше его использовать, и какие результаты он выдает'
      ]
    },
    {
      number: '12',
      title: 'Agent Mode: у ChatGPT появились руки',
      topics: [
        'Освоишь Agent Mode — объединение всех инструментов ChatGPT в один комбаин',
        'Научишься делегировать многошаговые задачи от начала до конца с самостоятельным планированием действий',
        'Поймешь, как Agent Mode может встроиться в твои системы'
      ]
    }
  ];
