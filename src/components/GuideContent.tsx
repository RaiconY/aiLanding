  ...
  const chapters = [
    ...
    },
    {
      ...
      topics: [
        ...
        'Изучишь 5 практических сценариев для решения проблем, которые возникают при общении с нейросетью'
      ]
    },
    {
      number: '04',
    ...
    {
      number: '11',
      title: 'Learn & Study Mode: ChatGPT как интерактивный учитель',
      topics: [
        'Поймешь, чем режим "Учёба и обучение" кардинально отличается от обычного ChatGPT',
        'Трансформируешь ChatGPT из источника готовых ответов в интерактивного учителя',
        'Научишься использовать прокаченные инструкции, которые добавляют каждому ответу ключевые детали для лучшего понимания'
      ]
    },
    {
      number: '12',
      title: 'Agent Mode: твой цифровой сотрудник, который может всё',
      topics: [
        'Освоишь Agent Mode — объединение всех инструментов ChatGPT в одного "цифрового сотрудника"',
        'Научишься делегировать многошаговые задачи от начала до конца с самостоятельным планированием действий',
        'Поймешь, как Agent Mode может логиниться в твои системы и работать с браузером, кодом и файлами одновременно'
      ]
    }
  ];
