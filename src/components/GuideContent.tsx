...
const GuideContent: React.FC = () => {
  const chapters = [
    {
      number: '01',
      title: 'Настрой ChatGPT за 10 минут вместо недель экспериментов',
      topics: [
    ...
    {
      number: '02',
      title: 'От игрушки к инструменту: 13 способов экономить 3 часа в день',
      topics: [
        'Внедришь 13 проверенных способов использования ChatGPT из моей личной жизни, которые экономят часы работы',
    ...
    {
      number: '03',
      title: 'Почему ИИ врет и как этого избежать',
      topics: [
        'Раскроешь для себя, что такое ChatGPT и LLM на самом деле — статистическая модель предсказания слов',
    ...
    {
      number: '04',
      title: 'Экономь до 200 000₽ на дизайнерах: создавай визуалы сам',
      topics: [
        ...
        'Начнешь экономить до 200 000₽ на дизайнерах, сохраняя качество на высоком уровне'
      ]
    },
    {
      number: '05',
    ...
    },
    {
      ...
      topics: [
        ...
        'Избежишь типичных ошибок при создании и настроишь GPTs для корпоративного использования'
      ]
    },
    {
      number: '07',
      title: 'Персональный ассистент, который работает без тебя',
      topics: [
    ...
    },
    {
      ...
      topics: [
        'Освоишь золотую формулу промпта: Роль → Задача → Контекст → Формат',
        'Изучишь 9 продвинутых техник промптинга и альтернативный диалоговый подход',
        'Поймешь иерархию инструкций и технические нюансы для максимальной эффективности'
      ]
    },
    {
      number: '09',
      title: 'Выбери правильный инструмент автоматизации и не переплачивай',
      topics: [
