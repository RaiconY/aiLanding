...
const TestimonialsScreenshots: React.FC = () => {
  const testimonials = [
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/400x280/4A90E2/FFFFFF?text=Screenshot+4'
    },
    {
      name: 'Александр С.',
      position: 'Предприниматель',
      text: 'Первые три дня использования ChatGPT после изучения материалов — это просто кайф полнейший!',
      imageUrl: 'https://via.placeholder.com/400x300/E76832/FFFFFF?text=Screenshot+5'
    },
    {
      name: 'Дмитрий В.',
      position: 'Маркетолог',
      text: 'Теперь решаю любые вопросы мгновенно: от планирования покупок до сложных рабочих задач 🔥',
      imageUrl: 'https://via.placeholder.com/400x260/FFC24B/FFFFFF?text=Screenshot+6'
    }
  ];
